...
const logger = createLogger({
  ...
  transports: [
    new transports.File({ filename: 'backend_logs/jsonanalysis.log' })
  ]
});

// 确保jsonanalysis目录存在
const JSONANALYSIS_DIR = '/home/ipv6/IPv6-project/jsonanalysis';
const TEMP_DIR = '/home/ipv6/IPv6-project/jsonanalysis/temp';
